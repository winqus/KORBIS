...
export const BottomSectionItemCameraControls = (props: {
  ...
  const { activeOption, onPressFlip, onPressCapture, onChangeOption } = props;
...
export const AddFindOptionsSegment = (props: {
  ...
  return (
    <View className={`flex-row justify-center ${containerClassName || "mb-6"}`}>
      <View className="flex-row bg-black/50 rounded-full overflow-hidden">
        <TouchableOpacity
          onPress={onPressAdd}
          className={`px-8 py-2 ${
...
export const CameraControlsRow = (props: {
  ...
  const { onPressFlip, onPressCapture, containerClassName } = props;
